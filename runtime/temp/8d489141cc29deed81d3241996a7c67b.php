<?php /*a:2:{s:80:"/Users/qwk/Desktop/thinkadmin/ThinkAdmin/application/wechat/view/news/index.html";i:1554692926;s:73:"/Users/qwk/Desktop/thinkadmin/ThinkAdmin/application/admin/view/main.html";i:1554692926;}*/ ?>
<div class="layui-card"><style>    #news-box {
        position: relative;
    }
    ...
    require(['jquery.masonry'], function (Masonry) {
        ...
        $('body').on('click', '[data-news-del]', function () {
            ...
            var dialogIndex = $.msg.confirm('确定要删除图文吗？', function () {
                $.form.load('<?php echo url("del"); ?>', {value: 0, field: 'delete', id: that.getAttribute('data-news-del')}, 'post', function (ret) {
                    if (ret.code) {
